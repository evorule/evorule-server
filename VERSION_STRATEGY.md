...
**预发布标签**:`v0.3.0-alpha.1` / `v0.3.0-beta.1`(发布前测试)
...
如 v0.3.0 开发期用本地 v0.3.2 开发版）。**发布前必须移除**——`scripts/validate-release.ps1`
